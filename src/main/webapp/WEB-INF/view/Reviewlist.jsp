...
<jsp:include page="header.jsp" />	
		...
		<!-- 상품후기 글쓰기 버튼 부분 -->
		<div>
			<div onclick="location.href='reviewinsert'" 
				style="width:800px; margin-left:780px; background-color:lightgrey;" >
				<img id="qnabu" align="left" style='cursor:pointer' src="images/review/iteminfo_button.jpg" />
			</div>
		</div>
