...
<body>
		...
		<div class="qnaframebox">
				...
				<div class="qna-textarea">
					...
					<div class="textarea-in">
						<textarea name="content" id="content" class="textarea" placeholder="내용을 입력해주세요" style="resize: none;"></textarea>
					</div>
				</div>
	<!-- 			<div class="qna-imageupload">
				...
				<div class="qnasubmit">
					 <input type="submit" id="qna_bu" value="등록하기"> 
					 <input type="button" id="qna_bu" value="작성취소" onclick="location.href='./qnalist'"/>
				</div>
