...
<!-- 	<div id="header">
	...
	<form action="qnaview" method="get" name="qna" onsubmit="return check();">
		...
		<P style='width:400px; margin-left:auto; margin-right :auto; text-align : center;'>비밀번호를 입력해주세요</P>
		<P style='width:400px; margin-left:auto; margin-right :auto; text-align : center;'><input type="text" id="pwd" name="pwd" /></P>
	...
	<%-- 	<input type="hidden" name="prod_cd" value="${prodcd}" />
		...
		<div style='width:400px; margin-left:auto; margin-right :auto; text-align : center;'>
	 	<input type="submit" class="submit" id="qna_bu" value="확인" />
 	 	<input type="button" class="cancel" id="qna_bu" value="취소" onclick="self.close()" />
		</div>
